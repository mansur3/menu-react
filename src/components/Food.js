...
function Food({image, name, description, calory, date, celcius, price, discountrate, icon1, icon2}) {
    return (
        <div className = "container">
            ...
            <div className = "product-details">
                ...
                <div className = "product-three">
                    <p className = "product-calory">{calory} Cal </p>
                    <p className = "product-date">P/F/C: {date}</p>
                    <p className = "product-celcius">{celcius} °c</p>
                </div>
